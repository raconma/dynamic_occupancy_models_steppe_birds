...
var coords = ee.FeatureCollection('projects/{project_name}/assets/ptealc_occ_wide_latlong'); 
...
var processPoint = function(point) {
  ...
  years.forEach(function(year) {
    ...
    var dateRangeEnd_ndviEvi = ee.Date.fromYMD(year, 8, 31);
    ...
    var dateRangeEnd_temperature = ee.Date.fromYMD(year, 8, 31);
...
Export.table.toDrive({
  ...
  description: 'ptealc_dynamic_variables',
  fileFormat: 'CSV'
});