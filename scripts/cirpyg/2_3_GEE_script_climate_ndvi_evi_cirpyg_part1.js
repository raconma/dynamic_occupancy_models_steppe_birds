// input
var coords = ee.FeatureCollection('projects/ee-rcontr03/assets/ebd_cirpyg_breeding_spain_zf_part1_landcover');
...
Export.table.toDrive({
  ...
  description: 'ebd_cirpyg_breeding_spain_zf_part1_variables',
  fileFormat: 'CSV'
});
