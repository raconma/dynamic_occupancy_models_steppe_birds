...
# load dataset
occ <- read.csv("../../data/cirpyg/occ_cirpyg_dynamic_wide_table.csv")
...
# Save results
write.csv(occ_wide_clean, "../../data/cirpyg/occ_cirpyg_dynamic_wide_table_clean.csv", row.names = FALSE)
