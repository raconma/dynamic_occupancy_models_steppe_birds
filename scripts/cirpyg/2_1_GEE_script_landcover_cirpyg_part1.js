...
var coords = ee.FeatureCollection('projects/ee-rcontr03/assets/ebd_cirpyg_breeding_spain_zf_part1');

// Visualize the data on the map
Map.addLayer(coords, {color: 'green'}, 'Circus pygargus. Presence - Absence');
...
Export.table.toAsset({
  ...
  assetId: 'projects/ee-rcontr03/assets/ebd_cirpyg_breeding_spain_zf_part1_landcover',
  description: 'ebd_cirpyg_breeding_spain_zf_part1_landcover'
});
