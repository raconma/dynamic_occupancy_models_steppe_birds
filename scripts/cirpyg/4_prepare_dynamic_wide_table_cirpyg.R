...
# load dataset
occ_var <- read.csv("../../data/cirpyg/ebd_cirpyg_breeding_spain_variables.csv")
...
write.table(occ_wide_total, "../../data/cirpyg/occ_cirpyg_dynamic_wide_table.csv", sep = ",", row.names = FALSE)
