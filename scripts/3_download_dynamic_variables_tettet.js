...
var coords = ee.FeatureCollection('projects/{project_name}/assets/tettet_occ_wide_latlong');
...
Export.table.toDrive({
  ...
  description: 'tettet_dynamic_variables', 
  fileFormat: 'CSV'
});