...
occ_raw <- read.csv("../data/ptealc/ebd_ptealc_breeding_spain_zf.csv")
...
write.csv(occ_species_observed, "../data/ptealc/ptealc_occ_species_observed.csv", row.names = FALSE)
...
write.csv(occ_wide_latlong, "../data/ptealc/ptealc_occ_wide_latlong.csv", row.names = FALSE)

write.csv(occ_wide_clean, "../data/ptealc/ptealc_occ_wide_static.csv", row.names = FALSE)