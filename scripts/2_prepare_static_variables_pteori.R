...
occ_raw <- read.csv("../data/pteori/ebd_pteori_breeding_spain_zf.csv")
...
write.csv(occ_species_observed, "../data/pteori/pteori_occ_species_observed.csv", row.names = FALSE)
...
write.csv(occ_wide_latlong, "../data/pteori/pteori_occ_wide_latlong.csv", row.names = FALSE)

write.csv(occ_wide_clean, "../data/pteori/pteori_occ_wide_static.csv", row.names = FALSE)