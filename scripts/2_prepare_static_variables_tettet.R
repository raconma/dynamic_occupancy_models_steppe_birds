...
occ_raw <- read.csv("../data/tettet/ebd_tettet_breeding_spain_zf.csv")
...
write.csv(occ_species_observed, "../data/tettet/tettet_occ_species_observed.csv", row.names = FALSE)
...
write.csv(occ_wide_latlong, "../data/tettet/tettet_occ_wide_latlong.csv", row.names = FALSE)

write.csv(occ_wide_clean, "../data/tettet/tettet_occ_wide_static.csv", row.names = FALSE)