...
# load dataset
occ_var <- read.csv("../../data/falnau/ebd_falnau_breeding_spain_variables.csv")
...
write.table(occ_wide_total, "../../data/falnau/occ_falnau_dynamic_wide_table.csv", sep = ",", row.names = FALSE)
