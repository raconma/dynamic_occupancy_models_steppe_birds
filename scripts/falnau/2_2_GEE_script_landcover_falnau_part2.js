...
var coords = ee.FeatureCollection('projects/ee-rcontr03/assets/ebd_falnau_breeding_spain_zf_part2');

// Visualize the data on the map
Map.addLayer(coords, {color: 'green'}, 'Falco naumanni. Presence - Absence');
...
Export.table.toAsset({
  ...
  assetId: 'projects/ee-rcontr03/assets/ebd_falnau_breeding_spain_zf_part2_landcover',
  description: 'ebd_falnau_breeding_spain_zf_part1_landcover'
});
