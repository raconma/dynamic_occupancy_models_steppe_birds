...
occ_raw <- read.csv("../data/otitar/ebd_otitar_breeding_spain_zf.csv")
...
write.csv(occ_species_observed, "../data/otitar/otitar_occ_species_observed.csv", row.names = FALSE)
...
write.csv(occ_wide_latlong, "../data/otitar/otitar_occ_wide_latlong.csv", row.names = FALSE)

write.csv(occ_wide_clean, "../data/otitar/otitar_occ_wide_static.csv", row.names = FALSE)