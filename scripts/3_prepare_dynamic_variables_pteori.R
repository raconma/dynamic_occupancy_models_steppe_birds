...
occ_wide_clean <- read.csv("../data/pteori/pteori_occ_wide_static.csv")

# Load the dynamic variables
dyn_var <- read.csv("../data/pteori/pteori_dynamic_variables.csv")
...
write.csv(occ_wide_clean, "../data/pteori/pteori_occ_wide_dynamic.csv", row.names = FALSE)
