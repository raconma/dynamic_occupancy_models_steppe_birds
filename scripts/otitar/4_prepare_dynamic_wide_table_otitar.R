...
# load dataset
occ_var <- read.csv("../../data/otitar/ebd_otitar_breeding_spain_variables.csv")
...
write.table(occ_wide_total, "../../data/otitar/occ_otitar_dynamic_wide_table.csv", sep = ",", row.names = FALSE)
