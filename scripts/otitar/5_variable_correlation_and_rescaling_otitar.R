...
# load dataset
occ <- read.csv("../../data/otitar/occ_otitar_dynamic_wide_table.csv")
...
# Save results
write.csv(occ_wide_clean, "../../data/otitar/occ_otitar_dynamic_wide_table_clean.csv", row.names = FALSE)
