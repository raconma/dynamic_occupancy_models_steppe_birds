...
# load dataset
occ <- read.csv("../../data/pteori/occ_pteori_dynamic_wide_table.csv")
...
# Save results
write.csv(occ_wide_clean, "../../data/pteori/occ_pteori_dynamic_wide_table_clean.csv", row.names = FALSE)
