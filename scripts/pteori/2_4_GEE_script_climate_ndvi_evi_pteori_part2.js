// input
var coords = ee.FeatureCollection('projects/ee-rcontr03/assets/ebd_pteori_breeding_spain_zf_part2_landcover');
...
Export.table.toDrive({
  ...
  description: 'ebd_pteori_breeding_spain_zf_part2_variables',
  fileFormat: 'CSV'
});
