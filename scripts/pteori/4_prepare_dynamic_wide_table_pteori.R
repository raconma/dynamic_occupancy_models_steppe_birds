...
# load dataset
occ_var <- read.csv("../../data/pteori/ebd_pteori_breeding_spain_variables.csv")
...
write.table(occ_wide_total, "../../data/pteori/occ_pteori_dynamic_wide_table.csv", sep = ",", row.names = FALSE)
