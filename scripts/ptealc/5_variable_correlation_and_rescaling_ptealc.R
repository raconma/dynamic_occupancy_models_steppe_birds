...
# load dataset
occ <- read.csv("../../data/ptealc/occ_ptealc_dynamic_wide_table.csv")
...
# Save results
write.csv(occ_wide_clean, "../../data/ptealc/occ_ptealc_dynamic_wide_table_clean.csv", row.names = FALSE)
