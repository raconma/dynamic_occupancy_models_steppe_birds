...
var coords = ee.FeatureCollection('projects/ee-rcontr03/assets/ebd_ptealc_breeding_spain_zf_part1');

// Visualize the data on the map
Map.addLayer(coords, {color: 'green'}, 'Pterocles alchata. Presence - Absence');
...
Export.table.toAsset({
  ...
  assetId: 'projects/ee-rcontr03/assets/ebd_ptealc_breeding_spain_zf_part1_landcover',
  description: 'ebd_ptealc_breeding_spain_zf_part1_landcover'
});
