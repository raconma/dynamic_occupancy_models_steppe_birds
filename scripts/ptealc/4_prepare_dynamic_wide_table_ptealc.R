...
# load dataset
occ_var <- read.csv("../../data/ptealc/ebd_ptealc_breeding_spain_variables.csv")
...
write.table(occ_wide_total, "../../data/ptealc/occ_ptealc_dynamic_wide_table.csv", sep = ",", row.names = FALSE)
