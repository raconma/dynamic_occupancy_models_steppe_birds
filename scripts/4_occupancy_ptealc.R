...
occ_wide_clean <- read.csv("../data/ptealc/ptealc_occ_wide_dynamic.csv")
...
#save result
write.csv(pred_occ,here("../data/ptealc/occ_ptealc_prediction.csv"), row.names = FALSE)

pred_occ <- read_csv(here("../data/ptealc/occ_ptealc_prediction.csv"))
...
writeRaster(raster_initial, "../data/ptealc/ptealc_OccuMap.tif", format = "GTiff", overwrite = TRUE)
