...
occ_raw <- read.csv("../data/cirpyg/ebd_cirpyg_breeding_spain_zf.csv")
...
write.csv(occ_species_observed, "../data/cirpyg/cirpyg_occ_species_observed.csv", row.names = FALSE)
...
write.csv(occ_wide_latlong, "../data/cirpyg/cirpyg_occ_wide_latlong.csv", row.names = FALSE)

write.csv(occ_wide_clean, "../data/cirpyg/cirpyg_occ_wide_static.csv", row.names = FALSE)